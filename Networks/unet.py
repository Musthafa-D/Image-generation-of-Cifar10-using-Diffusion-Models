    ...
    def __init__(self, n_steps, name, time_emb_dim, in_channels, hidden_channels, 
        ...
        for i in reversed(range(num_layers)):
            ...
            if i != 0:
                ...
                for j in range(block_layers):
                    if j == 0:
                        decoder_block.append(ConvBlock((in_channels * 2, 32 // (2 ** i), 32 // (2 ** i)), in_channels * 2, out_channels, act))
                    elif j == 1:
...
class Conditional_UNet(BaseNetwork):
    def __init__(self, n_steps, name, time_emb_dim, label_emb_dim, num_classes, 
        ...
        self.logger = get_logger()
        self.logger.info("Conditional Unet network.")
